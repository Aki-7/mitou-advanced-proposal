...
関してはぜひそちらを参照されたい．
\begin{itemize}
  \item \textbf{デモ動画：\url{https://drive.google.com/file/d/1UNNtEeYg0LZFHkuIhylTkkRVHMmloUHZ/view}}
\end{itemize}
% TODO: https://sites.google.com/view/zigen/%E3%83%87%E3%83%A2 のサムネが生成されたらこのページへのリンクに差し替える
